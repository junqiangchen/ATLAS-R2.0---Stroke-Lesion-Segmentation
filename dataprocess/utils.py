...
if __name__ == '__main__':
    save_file2csv(r'D:\challenge\data\ATLASR2.0\process\train', 'data/traindata.csv')
    save_file2csv(r'D:\challenge\data\ATLASR2.0\process\validation', 'data/validata.csv')
